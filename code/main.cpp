...
//NOTE(adm244): addresses for hooks (morrowind)
...
typedef int (* _PrintToConsole)(uint32 unk0, char *format, ...);
extern const _PrintToConsole PrintToConsole;
const _PrintToConsole PrintToConsole = (_PrintToConsole)0x0040F970;
// ###
